...
public class Constant {
    ...
    public static final String PREF_SELLER_DETAILS = "sellerDetails";
    ...
    public static final String MENU_OUTLETS = "outlets";
    ...
    public static final String OUTLET_ZONE = "outletZone";
    public static final String OUTLET_AREA = "outletArea";
    public static final String CONTRACT_URL = "contractUrl";
    public static final String OPENING_HOUR_MONDAY = "monday";
    public static final String OPENING_HOUR_TUESDAY = "tuesday";
    public static final String OPENING_HOUR_WEDNESDAY = "wednesday";
    public static final String OPENING_HOUR_THURSDAY = "thursday";
    public static final String OPENING_HOUR_FRIDAY = "friday";
    public static final String OPENING_HOUR_SATURDAY = "saturday";
    public static final String OPENING_HOUR_SUNDAY = "sunday";

    public static final String LEGAL_TYPE_PRIVACY = "privacy";
    public static final String LEGAL_TYPE_REFUND_CANCELLATION = "refundCancellation";
    public static final String LEGAL_TYPE_CANCELLATION = "cancellation";
    public static final String LEGAL_TYPE_ABOUT = "about";
